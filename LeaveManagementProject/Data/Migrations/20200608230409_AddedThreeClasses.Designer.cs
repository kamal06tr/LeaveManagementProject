...
namespace LeaveManagementProject.Data.Migrations
{
    ...
    [Migration("20200608230409_AddedThreeClasses")]
    partial class AddedThreeClasses
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LeaveManagementProject.Data.LeaveAllocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LeaveManagementProject.Data.LeaveHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LeaveManagementProject.Data.LeaveType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LeaveManagementProject.Data.Employee", b =>
                {
            ...
            modelBuilder.Entity("LeaveManagementProject.Data.LeaveAllocation", b =>
                {
                    b.HasOne("LeaveManagementProject.Data.Employee", "Employee")
                        .WithMany()
                        .HasForeignKey("EmployeeId");

                    b.HasOne("LeaveManagementProject.Data.LeaveType", "LeaveType")
                        .WithMany()
            ...
            modelBuilder.Entity("LeaveManagementProject.Data.LeaveHistory", b =>
                {
                    b.HasOne("LeaveManagementProject.Data.Employee", "ApprovedBy")
                        .WithMany()
                    ...
                    b.HasOne("LeaveManagementProject.Data.Employee", "RequestingEmployee")
                        .WithMany()
